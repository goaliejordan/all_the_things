...
def send_email():
    ...
    parser.add_argument('--gmail-user', '-u', type=str, dest='gmail_user',
                        help='Name of the gmail account to send the emails.')
    parser.add_argument('--gmail-pass', '-p', type=str, dest='gmail_password',
                        help='password for the gmail account')
    ...
    if len(reference_name) != len(reference_email):
        ...
        for reference, email in zip(reference_name, reference_email):
            ...
            subject = 'Character reference for {}'.format(applicant_name)
            body = """
            ...
            {} has volunteered to serve in a ministry at Grace Covenant Church that provides care for minors.  
            As such, they have agreed to allow us to do a background check; 
            part of that process involves allowing us to contact the character references they have provided to us. 
            ...
            On a scale of 1 to 10, with 10 being very strong and 1 being not at all, 
            how would you rate the applicant in the following areas:  (If needed, please write additional comments below)
            ...
            480-494-7668
            """.format(reference, applicant_name, email, applicant_name)
            email_text = 'Subject: {}\n\n{}'.format(subject, body)
